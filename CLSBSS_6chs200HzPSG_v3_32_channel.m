...
%% ========================= 单个ID号的被试数据 =================================================
eeglab;
localfile = 'D:\\matlab_tools\\eeglab2022.0\\plugins\\dipfit\\standard_BEM\\elec\\standard_1005.elc';  % 电极文件

fpath =   sprintf('D:/sleep data/Graduation_data/_BPOriginData');
fname =   sprintf('CLA034_2023_04_01_.vhdr');
subID_name ='CLA034';
RecordStartTime = [2023, 4, 1,    23, 16, 33];   % 年 月 日    时 分 秒
